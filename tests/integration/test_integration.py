...
@pytest.fixture
def automl_estimator(split_data):
...
def test_get_feature_importance_scores(automl_estimator):
...
def test_get_partial_dependence_plots(automl_estimator):
